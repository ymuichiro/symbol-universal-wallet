import { Account, Mosaic} from './model'
...
export async function transfer({ signerPublicKey, mosaicId, amount, address, message }: { signerPublicKey: string | undefined, mosaicId: string, amount: string, address: string, message: string }): Promise<string> {
    try{
