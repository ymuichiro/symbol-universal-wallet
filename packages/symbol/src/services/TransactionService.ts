import { buildQueryString, getTransactionType, getNetworkType, hexToAddress, convertToMosaicArray, getDataFromApi } from './utils';
...
export default class TransactionService {
    ...
    static tryParseTransferTransaction(data: any): TransferTransaction {
        const { meta } = data;
        const { size, signature, signerPublicKey, version, network, type, maxFee, deadline, recipientAddress, mosaics } = data.transaction;
